...
\item[\faIcon{backup}] Backup and recovery planning
\end{itemize}
\column{0.5\textwidth}
...
\begin{itemize}
\item[\faIcon{target}] Identify components in a web application
...
\begin{frame}[fragile]{Practical Example: Secure Web Application Architecture}
\begin{columns}
\column{0.5\textwidth}
...
\item \textbf{Application Layer}
\begin{itemize}
\item Node.js/Express applications
\item Horizontal scaling
\item Session management
\end{itemize}
\item \textbf{Database Layer}
\begin{itemize}
\item PostgreSQL primary
\item Redis caching
\item Read replicas
\end{itemize}
